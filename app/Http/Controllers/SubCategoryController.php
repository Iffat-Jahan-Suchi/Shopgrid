...
class SubCategoryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return redirect('/add-sub-category')->with('message', 'Sub Category create successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-sub-category')->with('message', 'SubCategory info update successfully.');
    }
